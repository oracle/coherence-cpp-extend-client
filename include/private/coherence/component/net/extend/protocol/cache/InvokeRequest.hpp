 ...
 */
#ifndef COH_INVOKE_REQUEST_HPP
#define COH_INVOKE_REQUEST_HPP
...
/**
* InvocableMap::invoke(Object::View vKey, EntryProcessor::View vAgent)
* Request message.
*
* @author jh  2008.02.29
*/
class COH_EXPORT InvokeRequest
    : public class_spec<InvokeRequest,
        extends<AbstractKeyRequest>,
        implements<PriorityTask> >
    {
    friend class factory<InvokeRequest>;

    // ----- constructors ---------------------------------------------------

    protected:
        /**
        * Create a new InvokeRequest instance.
        */
        InvokeRequest();
