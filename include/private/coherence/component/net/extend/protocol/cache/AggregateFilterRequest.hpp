 ...
 */
#ifndef COH_AGGREGATE_FILTER_REQUEST_HPP
#define COH_AGGREGATE_FILTER_REQUEST_HPP
...
/**
* InvocableMap::aggregate(Filter::View vFilter, EntryAggregator::View vAgent)
* Request message.
*
* @author jh  2008.02.29
*/
class COH_EXPORT AggregateFilterRequest
    : public class_spec<AggregateFilterRequest,
        extends<AbstractFilterRequest>,
        implements<PriorityTask> >
    {
    friend class factory<AggregateFilterRequest>;

    // ----- constructors ---------------------------------------------------

    protected:
        /**
        * Create a new AggregateFilterRequest instance.
        */
        AggregateFilterRequest();
...
#endif // COH_AGGREGATE_FILTER_REQUEST_HPP
