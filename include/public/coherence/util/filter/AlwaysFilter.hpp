 ...
 */
#ifndef COH_ALWAYS_FILTER_HPP
#define COH_ALWAYS_FILTER_HPP
...
*/
class COH_EXPORT AlwaysFilter
    : public class_spec<AlwaysFilter,
        extends<Object>,
        implements<IndexAwareFilter, PortableObject> >
    {
    friend class factory<AlwaysFilter>;
