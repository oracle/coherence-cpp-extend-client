...
/**
* Test suite for the LinkedList object.
*
* 2008.02.08 nsa
*/
class LinkedListTest : public CxxTest::TestSuite
    ...
    public:
        ...
        void testAddAllIndex()
            ...
            LinkedList::Handle hList2 = LinkedList::create();
        ...
        void testClone()
            ...
            LinkedList::View vList = hList;
            LinkedList::Handle hListClone = cast<LinkedList::Handle>(vList->clone());
