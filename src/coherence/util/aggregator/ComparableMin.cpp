...
COH_REGISTER_PORTABLE_CLASS(25, ComparableMin);
...
ComparableMin::ComparableMin()
    {
    }

ComparableMin::ComparableMin(ValueExtractor::View vExtractor,
        Comparator::View vComparator)
    : super(vExtractor, vComparator)
    {
    }

ComparableMin::ComparableMin(String::View vsMethod, Comparator::View vComparator)
...
void ComparableMin::process(Object::View v, bool /*fFinal*/)
    {
    if (v != NULL)
        {
